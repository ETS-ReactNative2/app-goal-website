        ...
        <div id="contact" className="Contact container-fluid"
            ...
            <div className='mx-auto h-100 d-flex flex-column justify-content-center align-content-center'>
                ...
                <div className="w-100 d-flex justify-content-center flex-column flex-md-row align-content-center mx-auto"
                    style={{ maxWidth: 768 }}>
                    <div className="p-2" style={{ width: '115%' }}>
                        <form className="d-flex flex-column justify-content-between h-100">
                            <div className="mb-3">
                                <input type="text" className="form-control" id="inputEmail3" placeholder="Nome"/>
                            </div>
                            <div className="mb-3">
                            ...
                            <div className="mb-3">
                                <textarea className="form-control" placeholder="Mensagem" rows={5}/>
                            </div>

                            <div>
                                <button type="submit" className="form-control btn btn-default">Enviar</button>
                            </div>
                        </form>
                    </div>
                    <div className="d-flex flex-column ml-4 border-left pl-4" style={{ width: '85%' }}>
